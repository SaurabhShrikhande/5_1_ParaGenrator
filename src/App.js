...
function pare (e){
   e.preventDefault();
  // setCount(document.getElementById("inp").value)
   ...
   setPara(a.slice(0, count))
}


  return (
    <div style={{backgroundColor:"#ffe6d6", minHeight:"100vh", display:"flex", justifyContent:"center"}}>
      <div style={{marginTop:"10vh" , display:"flex", flexDirection:"column", alignItems:"center"}}>
         <h3>TIRED OF BORING LOREM IPSUM?</h3>
         <div>
         <form onSubmit={pare}>
          <label>Paragraphs: </label>   
          <input style={{border:"none", borderRadius:"5px", padding:"7.5px 15px", marginInline:"15px"}} 
          type="number" 
          id="inp"
          value = {count}
           onChange = {(e) => setCount(e.target.value)}
          />
          <button style={{backgroundColor:"orange", color:"white", border:"none", borderRadius:"5px", padding:"7.5px 15px",}}
          onClick={()=>{}}>GENRATE</button>
          </form>
         </div>
        

         <div style={{textAlign:"center", marginInline:"5vw", marginTop:"5vh"}}>
          {
          para.map((item, idx) => {
